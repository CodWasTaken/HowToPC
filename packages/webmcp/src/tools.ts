...
export function createTools(b:ToolBridge){return [
 ...
 {name:"search_components",description:"Search normalized PC components with apply-now compatibility.",inputSchema:{type:"object",properties:{query:{type:"string"},category:{type:"string"}},additionalProperties:false},annotations:{readOnlyHint:true},execute:(i:any)=>b.searchComponents(i)},
