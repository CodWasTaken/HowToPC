import type { ProductSource, ReferenceProduct } from "./product";

const GiB = 1024 ** 3;
const TiB = 1024 ** 4;
const fixtureSource: ProductSource = { label: "HowToPC reference fixture", evidence: "REFERENCE" };

export const fixtureCatalog: readonly ReferenceProduct[] = [
  ...
  {id:"case-atx-340",revisionId:"case-atx-340-r1",manufacturer:"Reference",displayName:"Airflow ATX 340",category:"CASE",source:fixtureSource,specs:{schemaVersion:1,supportedMotherboardFormFactors:["MINI_ITX","MATX","ATX"],maxGpuLengthMm:340,maxCpuCoolerHeightMm:170,psuFormFactors:["ATX","SFX"],internal25Bays:2,internal35Bays:4}},
