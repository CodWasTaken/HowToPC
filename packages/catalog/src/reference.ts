...
export const referenceCatalog: readonly ReferenceProduct[] = [
  ...
  {id:"mb-b650-atx",revisionId:"mb-b650-atx-r1",manufacturer:"Reference",displayName:"B650 ATX WiFi",category:"MOTHERBOARD",source:fixtureSource,specs:{schemaVersion:1,socket:"AM5",formFactor:"ATX",memoryType:"DDR5",dimmSlots:4,maxMemoryBytes:192*GiB,pcieSlots:3,m2Slots:3,sataPorts:4}},
  {id:"mb-b650-itx",revisionId:"mb-b650-itx-r1",manufacturer:"Reference",displayName:"B650 Mini-ITX",category:"MOTHERBOARD",source:fixtureSource,specs:{schemaVersion:1,socket:"AM5",formFactor:"MINI_ITX",memoryType:"DDR5",dimmSlots:2,maxMemoryBytes:96*GiB,pcieSlots:1,m2Slots:2,sataPorts:2}},
